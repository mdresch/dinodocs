    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/mdresch/dinodocs/tree/main/packages/create-docusaurus/templates/shared/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/mdresch/dinodocs',
          label: 'GitHub',
          position: 'right',
        },
      ],
